...
const GetStartedPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                let dashboardUrl = 'http://app.localhost:3000/dashboard';
                if (window.location.hostname !== 'localhost') {
                    dashboardUrl = 'https://app.nepostore.xyz/dashboard';
                }
    ...
    // Use a custom logo icon like the one in the image (multiple circles/shapes)
    const LogoIcon = () => (
